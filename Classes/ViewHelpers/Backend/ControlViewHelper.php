...
use SGalinski\SgCookieOptin\ViewHelpers\Backend\Traits\ControlViewHelperTrait;
...
if ($typo3Version >= 10000000) {
    class ControlViewHelper extends \TYPO3Fluid\Fluid\Core\ViewHelper\AbstractViewHelper {
        use ControlViewHelperTrait;
    }
} else {
    class ControlViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
        use ControlViewHelperTrait;
    }
}
